...
> **token ใส่ทำไม:** สคริปต์ ML ไม่มี login → แนบ `x-api-token` แทน
> **ต้องใส่เสมอ** แม้รันบนเครื่องเดียวกับ server — เพราะ app ที่ webmanager deploy ไปก็รันอยู่บนเครื่องนั้น
> การมาจาก 127.0.0.1 จึงไม่ใช่หลักฐานว่าเป็นผู้ดูแลระบบ
